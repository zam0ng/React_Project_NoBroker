        ...
        // ✅✅PAC_MAP 에서 한 거랑 합치기
            // api 가져오는 함수 정의만 함. 아직 쓴건 아님. 
                ...
                const { data , error , isLoading } = useQuery( ['filterTradableEstateData' , checkboxValue] , fetchFilterTradableEstateData , {
                    enabled : !!checkboxValue // 📛 혹시 이것 때문에, 값이 비어있으면 안 가져오는거 아닌가.
                })
    ...
    return (
        <>                  
                <SubHeaderWrapper>
                    <SearchContainer>
                        <SearchBarContainer>
                                <input  className='searchBarTest' id="autocomplete" ref={autoCompleteRef} placeholder="서울대입구 원룸" type="text" style={{width : "100%"}} /> 
                        </SearchBarContainer>
                    </SearchContainer>
