    ...
    // [react-query 로 데이터 가져오기] 
        ...
        let currentMarkers = []; // 현재 활성화된 마커들을 저장하기 위한 변수
        ...
        const setMarker = () => {
            ...
            try {
                ...
                // 클러스터로 그룹화 하기 | 
                currentClusterer = new window.MarkerClusterer(map, newMarkers,  {
            ...
            currentMarkers = newMarkers; // 새로 생성된 마커들을 currentMarkers에 저장
