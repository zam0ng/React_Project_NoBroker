...
const PlacesAutocomplete = ({setSelected}) => {
    ...
    // usePlacesAutocomplete hook 이 '반환' 하는 것들
    const {
        ready,  // 주소 자동 완성 기능이 '가능한 상태인가'  

        value,  // 사용자가 입력한 주소값을 저장. 사용자가 입력한 부분. 이게 들어가면, 자동적으로 서버에 요청을 보내서 결과를 받는다. 
        setValue,   // 사용자가 입력한 값을 'value' 에 설정 | useState 에서 set 이라고 보면 될 듯
        ...
        // [해석] 
            // 사용자가 입력한 value 가 있으면 -> 서버에 요청을 보내고 -> 서버에서 유사한 추천을 찾아서 -> data 로 반환해준다. 
            // 이 과정에 '서버에 요청 보내는 과정' 이 들어가 있다. 
